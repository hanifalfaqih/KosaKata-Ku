...
import id.allana.kosakata.ui.kosakata.KosaKataFragmentDirections

class KosaKataAdapter : ListAdapter<Word, KosaKataAdapter.WordViewHolder>(WordsComparator()) {
    ...
    class WordViewHolder(private val binding: ListItemWordBinding) :
        ...
        fun bind(data: Word) {
            ...
            itemView.setOnClickListener {
                val action =
                    KosaKataFragmentDirections.actionNavigationKosaKataToDetailKosaKataFragment(data)
